...
const Page1 = () => {
    return (
        ...
        <section className="w-full flex justify-between items-center py-20 px-20">
            <div className="w-2/3">
        <h1 className="text-9xl font-serif leading-[0.85] font-normal w-4/5">
            Turning heads
            and conquering
            hearts  <div className="w-20 inline-block">
                <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 52 52" fill="none" preserveAspectRatio="xMidYMid meet" aria-hidden="true" role="img" className="animate">
        ...
        <div className="flex flex-col gap-5">
            <p className="w-4/6 text-2xl">NiceAtNoon is a boutique design studio specializing in branding and web design.</p>
            <button className="py-5 px-10 rounded-2xl text-lg w-56 bg-white border-solid border-2 font-semibold duration-500 text-zinc-600 hover:underline hover:rounded-[3rem] ">View Project<i className="ri-arrow-right-line text-black ml-4"></i></button>

        </div>
        </div>
        </section>
        <Card/>
        <p className="px-20 text-3xl">
        NiceAtNoon is een fijnschalige design studio voor merken die de hoofden en de harten van hun publiek willen
    ...
    aantrekkingskracht. Raak en verbind jouw doelgroepen als nooit tevoren!
        ...
        <button className="py-5 px-10 rounded-2xl text-lg  bg-white border-solid border-2 font-semibold duration-500 text-zinc-600 hover:underline hover:rounded-[3rem] ">Leer ons kennen
        <i className="ri-arrow-right-line text-black ml-4"></i></button>
        </div>
        </>
